        ...
        <View style={styles.webMapMock}>
          ...
          {selectedPlace ?
            <View style={styles.markerBox}>
              <Ionicons name="location-sharp" size={38} color="#2158E8" />
              <Text style={styles.markerLabel}>{selectedPlace.name}</Text>
            </View>
          : <View style={styles.mapEmptyBox}>
              <Ionicons name="map-outline" size={38} color="#8EA0B8" />
              <Text style={styles.mapEmptyText}>장소를 검색해보세요</Text>
            </View>
          }
        </View>
